 ...
 * Props for `BigText`.
 */
export type BigTextProps = object;

/**
 * Component for "BigText" Slices.
 */
const BigText = ({}: BigTextProps): JSX.Element => {
  return (
    <section className="font-[family-name:var(--font-canopee)] min-h-screen w-screen overflow-hidden bg-[#fff2ee] text-[#ff9777]">
